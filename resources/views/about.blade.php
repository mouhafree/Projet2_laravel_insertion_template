                                    ...
                                    <li class="position-static"><a href="#">Our Collections <i class="fi-rs-angle-down"></i></a>
                                        <ul class="mega-menu">
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                ...
                                                <ul>
                                                    <li><a href="{{asset('produit_details')}}">Dresses</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Blouses & Shirts</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Hoodies & Sweatshirts</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Wedding Dresses</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Prom Dresses</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Cosplay Costumes</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">Men's Fashion</a>
                                                <ul>
                                                    <li><a href="{{asset('produit_details')}}">Jackets</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Casual Faux Leather</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Genuine Leather</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Casual Pants</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Sweatpants</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Harem Pants</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">Technology</a>
                                                <ul>
                                                    <li><a href="{{asset('produit_details')}}">Gaming Laptops</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Ultraslim Laptops</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Tablets</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Laptop Accessories</a></li>
                                                    <li><a href="{{asset('produit_details')}}">Tablet Accessories</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="{{asset('produit_details')}}"><img src="assets/imgs/banner/menu-banner.jpg" alt="Surfside Media"></a>
                                                    <div class="menu-banner-content">
                                                        ...
                                                        <div class="menu-banner-btn">
                                                            <a href="{{asset('produit_details')}}">Shop now</a>
                                                        </div>
                                                    </div>
