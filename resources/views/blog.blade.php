                    ...
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Get great devices up to 50% off <a href="{{asset('shop')}}">View details</a></li>
                                    <li>Supper Value Deals - Save more with coupons</li>
                                    <li>Trendy 25silver jewelry, save up 35% off today <a href="{{asset('shop')}}">Shop now</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="{{asset('/')}}"><img src="assets/imgs/logo/logo.png" alt="logo"></a>
                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="{{asset('produits')}}"><img alt="Surfside Media" src="assets/imgs/shop/thumbnail-3.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="{{asset('produits')}}">Daisy Casual Bag</a></h4>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="{{asset('produits')}}"><img alt="Surfside Media" src="assets/imgs/shop/thumbnail-2.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="{{asset('produits')}}">Corduroy Shirts</a></h4>
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    <li class="has-children">
                                        <a href="{{asset('shop')}}"><i class="surfsidemedia-font-dress"></i>Women's Clothing</a>
                                    ...
                                    <li class="has-children">
                                        <a href="{{asset('shop')}}"><i class="surfsidemedia-font-tshirt"></i>Men's Clothing</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                    ...
                                    <li class="has-children">
                                        <a href="{{asset('shop')}}"><i class="surfsidemedia-font-smartphone"></i> Cellphones</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                    ...
                                    <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-desktop"></i>Computer & Office</a></li>
                                    <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-cpu"></i>Consumer Electronics</a></li>
                                    <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-diamond"></i>Jewelry & Accessories</a></li>
                                    <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-home"></i>Home & Garden</a></li>
                                    <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-high-heels"></i>Shoes</a></li>
                                    <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-teddy-bear"></i>Mother & Kids</a></li>
                                    <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-kite"></i>Outdoor fun</a></li>
                                    <li>
                                        <ul class="more_slide_open" style="display: none;">
                                            <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-desktop"></i>Beauty, Health</a></li>
                                            <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-cpu"></i>Bags and Shoes</a></li>
                                            <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-diamond"></i>Consumer Electronics</a></li>
                                            <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-home"></i>Automobiles & Motorcycles</a></li>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="{{asset('blog')}}">About</a></li>
                                    ...
                                    <li class="position-static"><a href="#">Our Collections <i class="fi-rs-angle-down"></i></a>
                                        <ul class="mega-menu">
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                ...
                                                <ul>
                                                    <li><a href="{{asset('produits')}}">Dresses</a></li>
                                                    <li><a href="{{asset('produits')}}">Blouses & Shirts</a></li>
                                                    <li><a href="{{asset('produits')}}">Hoodies & Sweatshirts</a></li>
                                                    <li><a href="{{asset('produits')}}">Wedding Dresses</a></li>
                                                    <li><a href="{{asset('produits')}}">Prom Dresses</a></li>
                                                    <li><a href="{{asset('produits')}}">Cosplay Costumes</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">Men's Fashion</a>
                                                <ul>
                                                    <li><a href="{{asset('produits')}}">Jackets</a></li>
                                                    <li><a href="{{asset('produits')}}">Casual Faux Leather</a></li>
                                                    <li><a href="{{asset('produits')}}">Genuine Leather</a></li>
                                                    <li><a href="{{asset('produits')}}">Casual Pants</a></li>
                                                    <li><a href="{{asset('produits')}}">Sweatpants</a></li>
                                                    <li><a href="{{asset('produits')}}">Harem Pants</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">Technology</a>
                                                <ul>
                                                    <li><a href="{{asset('produits')}}">Gaming Laptops</a></li>
                                                    <li><a href="{{asset('produits')}}">Ultraslim Laptops</a></li>
                                                    <li><a href="{{asset('produits')}}">Tablets</a></li>
                                                    <li><a href="{{asset('produits')}}">Laptop Accessories</a></li>
                                                    <li><a href="{{asset('produits')}}">Tablet Accessories</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="{{asset('produits')}}"><img src="assets/imgs/banner/menu-banner.jpg" alt="Surfside Media"></a>
                                                    <div class="menu-banner-content">
                                                        ...
                                                        <div class="menu-banner-btn">
                                                            <a href="{{asset('produits')}}">Shop now</a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        <li>
                                            ...
                                            <div class="shopping-cart-title">
                                                <h4><a href="{{asset('produits')}}">Plain Striola Shirts</a></h4>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="{{asset('produits')}}"><img alt="Surfside Media" src="assets/imgs/shop/thumbnail-4.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                                <h4><a href="{{asset('produits')}}">Macbook Pro 2022</a></h4>
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <div class="main-categori-wrap mobile-header-border">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-small">
                            <ul>
                                <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-dress"></i>Women's Clothing</a></li>
                                <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-tshirt"></i>Men's Clothing</a></li>
                                <li> <a href="{{asset('shop')}}"><i class="surfsidemedia-font-smartphone"></i> Cellphones</a></li>
                                <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-desktop"></i>Computer & Office</a></li>
                                <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-cpu"></i>Consumer Electronics</a></li>
                                <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-home"></i>Home & Garden</a></li>
                                <li><a href="{{asset('shop')}}"><i class="surfsidemedia-font-high-heels"></i>Shoes</a></li>
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="{{asset('shop')}}">shop</a></li>
                                ...
                                <ul class="dropdown">
                                    <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Women's Fashion</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="{{asset('produits')}}">Blouses & Shirts</a></li>
                                            <li><a href="{{asset('produits')}}">Hoodies & Sweatshirts</a></li>
                                            <li><a href="{{asset('produits')}}">Women's Sets</a></li>
                                        </ul>
                                    </li>
        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    <a href="{{asset('/')}}" rel="nofollow">Home</a>
                    <span></span> Blog
                                    ...
                                    <article class="first-post mb-30 wow fadeIn animated hover-up">
                                        ...
                                        <div class="entry-content">
                                            <div class="entry-meta meta-1 mb-30">
                                                <a class="entry-meta meta-0" href="{{asset('blog')}}"><span class="post-in background4 text-brand font-xs">Mobile Phone</span></a>
                                                <div class="font-sm">
                                            ...
                                            <div class="mb-20 entry-meta meta-2">
                                                <div class="font-xs ">
                                                    <span class="post-by">By <a href="{{asset('blog')}}">Azimeto</a></span>
                                    ...
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        <div class="post-thumb img-hover-scale">
                                            ...
                                            <div class="entry-meta">
                                                <a class="entry-meta meta-2" href="{{asset('blog')}}">Politic</a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        <div class="post-thumb img-hover-scale">
                                            ...
                                            <div class="entry-meta">
                                                <a class="entry-meta meta-2" href="{{asset('blog')}}">Global</a>
                                            </div>
                                        </div>
                                        <div class="entry-content-2">
                                            <h3 class="post-title mb-15">
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        <div class="post-thumb img-hover-scale">
                                            ...
                                            <div class="entry-meta">
                                                <a class="entry-meta meta-2" href="{{asset('blog')}}">Sport</a>
                                            </div>
                                        </div>
                                        <div class="entry-content-2">
                                            <h3 class="post-title mb-15">
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        <div class="post-thumb img-hover-scale">
                                            ...
                                            <div class="entry-meta">
                                                <a class="entry-meta meta-2" href="{{asset('blog')}}">Technology</a>
                                            </div>
                                        </div>
                                        <div class="entry-content-2">
                                            <h3 class="post-title mb-15">
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        <div class="post-thumb img-hover-scale">
                                            ...
                                            <div class="entry-meta">
                                                <a class="entry-meta meta-2" href="{{asset('blog')}}">Watch</a>
                                            </div>
                                        </div>
                                        <div class="entry-content-2">
                                            <h3 class="post-title mb-15">
                        ...
                        <div class="widget-area">
                            ...
                            <div class="sidebar-widget widget_categories mb-40">
                                ...
                                <div class="post-block-list post-module-1 post-module-5">
                                    <ul>
                                        <li class="cat-item cat-item-2"><a href="{{asset('blog')}}">Beauty</a> (3)</li>
                                        <li class="cat-item cat-item-3"><a href="{{asset('blog')}}">Book</a> (6)</li>
                                        <li class="cat-item cat-item-4"><a href="{{asset('blog')}}">Design</a> (4)</li>
                                        <li class="cat-item cat-item-5"><a href="{{asset('blog')}}">Fashion</a> (3)</li>
                                        <li class="cat-item cat-item-6"><a href="{{asset('blog')}}">Lifestyle</a> (6)</li>
                                        <li class="cat-item cat-item-7"><a href="{{asset('blog')}}">Travel</a> (2)</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none animated">
                                ...
                                <div class="banner-text">
                                    ...
                                    <a href="{{asset('shop')}}">Shop Now <i class="fi-rs-arrow-right"></i></a>
                                </div>
                            </div>
                            <!--Widget Tags-->
                            <div class="sidebar-widget widget_tags mb-50">
                                ...
                                <div class="tagcloud">
                                    <a class="tag-cloud-link" href="{{asset('blog')}}">New York</a>
                                    <a class="tag-cloud-link" href="{{asset('blog')}}">beautiful</a>
                                    <a class="tag-cloud-link" href="{{asset('blog')}}">droll</a>
                                    <a class="tag-cloud-link" href="{{asset('blog')}}">intimate</a>
                                    <a class="tag-cloud-link" href="{{asset('blog')}}">loving</a>
                                    <a class="tag-cloud-link" href="{{asset('blog')}}">travel</a>
                                    <a class="tag-cloud-link" href="{{asset('blog')}}">fighting </a>
                                </div>
                            </div>
                        </div>
                    </div>
