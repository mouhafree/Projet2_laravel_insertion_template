                ...
                <div class="row">
                        ...
                        <div class="row product-grid-3">
                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="{{asset('shop')}}">Music</a>
                                        </div>
                                        <h2><a href="{{asset('produits')}}">Colorful Pattern Shirts</a></h2>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{asset('produits')}}">Cartoon Astronaut T-Shirts</a></h2>
                                        <div class="rating-result" title="90%">
                                            <span>
                                                <span>50%</span>
                                            </span>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="{{asset('shop')}}">Watch</a>
                                        </div>
                                        <h2><a href="{{asset('produits')}}">Plain Striola Shirts</a></h2>
                                        <div class="rating-result" title="90%">
                                            <span>
                                                <span>95%</span>
                                            </span>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{asset('produits')}}">Landscape Painting Shirt</a></h2>
                                        <div class="rating-result" title="90%">
                                            <span>
                                                <span>70%</span>
                                            </span>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="{{asset('shop')}}">Speaker</a>
                                        </div>
                                        <h2><a href="{{asset('produits')}}">Letter Print T-Shirt</a></h2>
                                        <div class="rating-result" title="90%">
                                            <span>
                                                <span>70%</span>
                                            </span>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="{{asset('shop')}}">Camera</a>
                                        </div>
                                        <h2><a href="{{asset('produits')}}">Element Pattern Print Shirts</a></h2>
                                        <div class="rating-result" title="90%">
                                            <span>
                                                <span>70%</span>
                                            </span>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="{{asset('shop')}}">Phone</a>
                                        </div>
                                        <h2><a href="{{asset('produits')}}">Vintage Henley Shirt</a></h2>
                                        <div class="rating-result" title="90%">
                                            <span>
                                                <span>98%</span>
                                            </span>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="{{asset('shop')}}">Accessories </a>
                                        </div>
                                        <h2><a href="{{asset('produits')}}">Cotton Leaf Printed</a></h2>
                                        <div class="rating-result" title="90%">
                                            <span>
                                                <span>70%</span>
                                            </span>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                <li><a href="{{asset('shop')}}">Shoes & Bags</a></li>
                                <li><a href="{{asset('shop')}}">Blouses & Shirts</a></li>
                                <li><a href="{{asset('shop')}}">Dresses</a></li>
                                <li><a href="{{asset('shop')}}">Swimwear</a></li>
                                <li><a href="{{asset('shop')}}">Beauty</a></li>
                                <li><a href="{{asset('shop')}}">Jewelry & Watch</a></li>
                                <li><a href="{{asset('shop')}}">Accessories</a></li>
                            </ul>
                        </div>
                        <!-- Fillter By Price -->
                        <div class="sidebar-widget price_range range mb-30">
                            ...
                            <a href="{{asset('shop')}}" class="btn btn-sm btn-default"><i class="fi-rs-filter mr-5"></i> Fillter</a>
                        </div>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h5><a href="{{asset('produits')}}">Chen Cardigan</a></h5>
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h6><a href="{{asset('produits')}}">Chen Sweater</a></h6>
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h6><a href="{{asset('produits')}}">Colorful Jacket</a></h6>
