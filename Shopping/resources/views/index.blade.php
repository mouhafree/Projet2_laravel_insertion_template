...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/templatemo-hexashop.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/owl-carousel.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/owl-lightbox.css') }}">
...
-->
    ...
    <!-- Plugins -->
    <script src="{{ asset('asstes/js/owl-carousel.js') }}"></script>
